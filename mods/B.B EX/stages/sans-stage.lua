function onCreate()
    ...
    if difficultyName == 'Hard' then
        makeAnimatedLuaSprite('frisk', 'BGsansFrisk', 1100, 180)
        addAnimationByPrefix('frisk', 'idle', 'Frisk', 24, true)
	    setScrollFactor('frisk', 0.9, 0.9)
	    addLuaSprite('frisk', false)
	    scaleObject('frisk', 0.5, 0.5);
	    
	    makeAnimatedLuaSprite('Papyrus', 'BGsansPapyrus', 1200, 110)
        addAnimationByPrefix('Papyrus', 'idle', 'Papyrus', 24, true)
	    setScrollFactor('Papyrus', 0.9, 0.9)
	    addLuaSprite('Papyrus', false)
	    scaleObject('Papyrus', 0.5, 0.5);
    elseif difficultyName == 'EX' then
        makeAnimatedLuaSprite('frisk', 'BGsansexpaps', 1100, 180)
        addAnimationByPrefix('frisk', 'idle', 'frisky', 24, true)
	    setScrollFactor('frisk', 0.9, 0.9)
	    addLuaSprite('frisk', false)
	    scaleObject('frisk', 0.5, 0.5);
	    
	    makeAnimatedLuaSprite('Papyrus', 'BGsansexpaps', 1200, 110)
